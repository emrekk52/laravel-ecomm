...
<?php $__env->startSection('title', $secilenmarka[0]->marka); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="features_items">
        <!--features_items-->
        <h2 class="title text-center">Markalar</h2>
            ...
            <section class="card-items">
                <div class="table-responsive cart_info" style="border: 2px solid rgb(0, 183, 255)">
                    ...
                    <p style="margin:0 auto !important; text-align:center;color:#ccc;font-size:70px">
                        <i class="fa fa-exclamation-circle"></i> <?php echo e($secilenmarka[0]->marka); ?> markasında ürün bulunamamaktadır!
                    </p>
                </div>
...
<?php echo $__env->make('layouts.front.fmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecomm\resources\views/front/marka.blade.php ENDPATH**/ ?>