...
<?php $__env->startSection('title', $secilentur[0]->adi); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="features_items">
        <!--features_items-->
        <h2 class="title text-center">Türler</h2>
        ...
        <?php else: ?>
            <section class="card-items">
                <div class="table-responsive cart_info" style="border: 2px solid rgb(212, 0, 255)">

                    <p style="margin:0 auto !important; text-align:center;color:#ccc;font-size:70px">
                        <i class="fa fa-exclamation-circle"></i> <?php echo e($secilentur[0]->adi); ?> kategorisinde ürün bulunamamıştır!
                    </p>
                </div>
...
<?php echo $__env->make('layouts.front.fmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecomm\resources\views/front/kategori.blade.php ENDPATH**/ ?>